...
public class AlgDialog extends DialogFragment {
                    ...
                    new MaterialDialog.Builder(getContext())
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(
                                ...
                                dbHandler.updateAlgorithmProgress(
                                    mId, seekProgress);
                    ...
                    new MaterialDialog.Builder(getContext())
                        ...
                        .onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(
                                    @NonNull MaterialDialog dialog,
                                    @NonNull DialogAction which) {
                                algorithm.setAlgs(AlgUtils.getDefaultAlgs(
                                    algorithm.getSubset(),
                                    algorithm.getName()));
                                dbHandler.updateAlgorithmAlg(
                                    mId, algorithm.getAlgs());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View dialogView
            = inflater.inflate(R.layout.dialog_alg_details, container);
        ...
        final Algorithm matchedAlgorithm
            = TwistyTimer.getDBHandler().getAlgorithm(mId);
        ...
        if (matchedAlgorithm != null) {
            ...
            if (algorithm.getSubset().equals("PLL")) {
                pllArrows.setImageDrawable(
                    AlgUtils.getPllArrow(getContext(), algorithm.getName()));
    ...
    private void updateList() {
        TTIntent.broadcast(TTIntent.CATEGORY_ALG_DATA_CHANGES,
                           TTIntent.ACTION_ALGS_MODIFIED);
        //dismiss();
    }
    ...
    private void colorCube(final String state) {
        ...
        final Map<Character, Integer> colorHash
            = AlgUtils.getColorLetterHashMap();
