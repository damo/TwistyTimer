...
/**
 * A dialog fragment for the customisation of the color-scheme of the cube
 * images generated to show the scrambles.
 */
public class SchemeSelectDialogMain extends DialogFragment {
    ...
    private final View.OnClickListener clickListener
        ...
        public void onClick(final View colorView) {
            ...
            picker.findViewById(R.id.okColorButton).setOnClickListener(
                new View.OnClickListener() {
                @Override
                public void onClick(View ignored) {
                    final int color = picker.getColor();

                    setColor(colorView, color);
                    faceColor.putColor(color);  // Save color to preferences.
                    picker.dismiss();
                }
            });
        }
    ...
    public View onCreateView(
        ...
        View dialogView = inflater.inflate(
            R.layout.dialog_scheme_select_main, container);
                ...
                new MaterialDialog.Builder(getContext())
                    ...
                    .onPositive(new MaterialDialog.SingleButtonCallback() {
                        ...
                        public void onClick(@NonNull MaterialDialog dialog,
                            ...
                            FaceColor.resetAllColors();

                            for (View face : faces) {
                                setColor(face, FaceColor.forViewID(
                                    face.getId()).getColor());
                            }
                        }
                    })
