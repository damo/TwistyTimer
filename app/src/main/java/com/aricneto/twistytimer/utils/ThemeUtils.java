...
public final class ThemeUtils {
    ...
    /**
     * An enumeration of the supported application themes for <i>Twisty
     * Timer</i>. Each value can be queried to retrieve useful related
     * information, such as the style resource IDs for the theme (the normal
     * theme and the associated no-background theme), the representative
     * color resource ID for the theme, and the ID of the view used to
     * present the theme color in the theme selection dialog.
     */
    public enum TTTheme {
        ...
        DEEP_PURPLE(R.style.DeepPurpleTheme,
            R.style.DeepPurpleTheme_NoBackground,
        ...
        /**
         * The ID of the view used to present the theme in the theme selection
         * dialog.
         */
        @IdRes
        ...
        /**
         * The resource ID of the theme's representative color used in the
         ...
         *     The resource ID of the theme's no-background style.
         * @param viewID
         *     The ID of the view used to present the theme in the theme
         *     selection dialog.
         * @param colorResID
         *     The resource ID of the theme's representative color used in the
         *     theme selection dialog.
         ...
         *
         * @return
         *     The theme that is represented by that view, or the default
         *     theme if the view ID is not recognised.
         */
        ...
        /**
         * Gets the view ID for the view that represents this theme in the
    ...
    /**
     * Gets the style resource ID for the user's preferred theme. This is the
     * theme that has been selected and saved to the preferences (or the default
     * theme); it is not necessarily the same as the theme that is currently
     * applied to the user interface. For each preferred theme, the style
     * resource ID depends on whether or not a colored background has been
     * enabled.
     *
     * @return
    ...
    public static int getPreferredThemeStyleResID() {
        // Returns the default theme, if not saved before.
        final TTTheme theme = Prefs.getTheme();

        return Prefs.getBoolean(
            R.string.pk_timer_bg_enabled, R.bool.default_timer_bg_enabled)
    ...
    public static Drawable tintDrawable(
            Context context, @DrawableRes int drawableRes,
            @AttrRes int colorAttrRes) {
        Drawable drawable = ContextCompat.getDrawable(context, drawableRes);
        Drawable wrap = DrawableCompat.wrap(drawable);
        DrawableCompat.setTint(
            wrap, ThemeUtils.fetchAttrColor(context, colorAttrRes));
    ...
    public static Drawable tintPositiveThumb(
            ...
            @AttrRes int colorAttrRes) {
        Drawable drawable
            = ContextCompat.getDrawable(context, R.drawable.thumb_circle);
        Drawable wrap = DrawableCompat.wrap(drawable);
        DrawableCompat.setTint(
            wrap, ThemeUtils.fetchAttrColor(context, colorAttrRes));
        DrawableCompat.setTintMode(wrap, PorterDuff.Mode.MULTIPLY);
